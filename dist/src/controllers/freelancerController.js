...
exports.showFreelancerProposalDetailsC = exports.showFreelancerProposalsC = exports.showFreelancerOffersC = exports.isAlreadyAppliedC = exports.addProposalC = exports.showSingleWorkController = exports.showWorksController = void 0;
...
const showFreelancerProposalDetailsC = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield (0, auth_1.checkAuthentication)(req, res);
        const id = req.params.id;
        (0, freelancerFeatures_1.showFreelancerProposalDetailsF)(req, res, user, id);
    }
    catch (err) {
        console.error("error while fetching offers in showFreelancerOffers at freelancerController.ts", err);
        return res.status(500).json({ message: 'error while fetching offers in showFreelancerOffers at freelancerController.ts' });
...
exports.showFreelancerProposalDetailsC = showFreelancerProposalDetailsC;
