...
exports.showFreelancerProposalDetailsF = exports.showFreelancerProposalsF = exports.showFreelancerOffersF = exports.isAppliedF = exports.addProposalF = exports.showWorkFeature = exports.showWorksFeature = void 0;
...
const showFreelancerProposalDetailsF = (req, res, user, id) => __awaiter(void 0, void 0, void 0, function* () {
    const freelancer = yield User_1.Freelancer.findOne({ user: user._id });
    if (!freelancer) {
        console.error('Freelancer not found');
        return res.status(404).json({ message: 'Freelancer not found' });
    }
    const proposalDetails = yield ProposalsModel_1.Proposals.findOne({ _id: id, freelancer: freelancer._id }).populate('service');
    if (!proposalDetails) {
...
exports.showFreelancerProposalDetailsF = showFreelancerProposalDetailsF;
//# sourceMappingURL=freelancerFeatures.js.map